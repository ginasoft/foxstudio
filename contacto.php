                     ...
                     <div class="row gaper align-items-center">
                        <div class="col-12 col-lg-5 col-xl-7">
                           <div class="text-center text-lg-start">
                              <h2 class="title title-anim">Contacto</h2>
                        ...
                        <div class="col-12 col-lg-7 col-xl-5">
                           <div class="text-center text-lg-start">
                              <p class="primary-text">Creemos que cada interacción cuenta. Escuchamos tus necesidades y las transformamos 
                                  en oportunidades. Te acompañamos en cada paso hacia la transformación digital de tu negocio.
</p>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-3">
                           <div class="contact-m__single topy-tilt fade-top">
                              ...
                              <div class="content">
                                 <h4>Reunión</h4>
                                 <p>
                                    <a href="https://calendly.com/foxstudioarg">Calendly</a>
                                 </p>
                              </div>
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-3">
                           <div class="contact-m__single topy-tilt fade-top">
                              ...
                              <div class="content">
                                 <h4>E-mail</h4>
                                 <p>
                                    <a href="mailto:info@foxstudio.com.ar">info@foxstudio.com.ar</a>
                                 </p>
                              </div>
                           </div>
                        </div>
