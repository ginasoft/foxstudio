                     ...
                     <div class="row gaper align-items-center">
                        <div class="col-12 col-lg-5 col-xl-7">
                           <div class="text-center text-lg-start">
                              <h2 class="title title-anim">Nosotros</h2>
                        ...
                        <div class="col-12 col-lg-7 col-xl-5">
                           <div class="text-center text-lg-start">
                              <p class="primary-text">A partir del análisis funcional de tus necesidades, diseñamos soluciones que aumentan la eficiencia de la gestión diaria de tu negocio, simplificando su control.
</p>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="row justify-content-center">
                                 <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-9">
                                    <div class="section__header text-center">
                                       <h2 class="title title-anim">Hablemos. Dejanos tu e-mail</h2>
                                    </div>
