                     ...
                     <div class="col-12 col-lg-5 col-xl-6">
                        <div class="footer__single">
                           <a href="index.php" class="logo">
                              <img src="assets/images/logo/large-logo-strong.png" alt="Image">
                           </a>
                           ...
                           <div class="footer__cta text-start">
                              <a href="https://calendly.com/foxstudioarg" class="btn btn--secondary">Agendá una reunión</a>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="col-12 col-lg-8">
                                 <div class="footer__copyright-text text-center text-lg-start">
                                    <p>
                                       ...
                                       FoxStudio. Todos los derechos reservados
                                    </p>
                                 </div>
                              </div>
