...
<?php include 'php/header-internas.php'; ?>
                     ...
                     <div class="row gaper align-items-center">
                        <div class="col-12 col-lg-5 col-xl-7">
                           <div class="text-center text-lg-start">
                              <h2 class="title title-anim">Servicios</h2>
                        ...
                        <div class="col-12 col-lg-7 col-xl-5">
                           <div class="text-center text-lg-start">
                              <p class="primary-text">Creemos que cada interacción cuenta. Convertí tus ideas en realidades digitales innovadoras y eficientes. Nuestro equipo está listo para guiarte a través de cada paso hacia la transformación digital de tu empresa.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                           <div class="section__header text-center">
                              ...
                              <h2 class="title title-anim">Interfaces UX/UI</h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                           ...
                           <div class="service-f-wrapper">
                              <div class="service-f-single fade-top">
                                 ...
                                 <div class="single-item p-single p-sm body-cn">
                                    <p>Entendemos a tu audiencia. Mediante un analisis detallado, identificamos las necesidades, 
                                       deseos y comportamientos de tus clientes para guiar cada aspecto del diseño y desarrollo.</p>
                                 </div>
                              ...
                              <div class="service-f-single fade-top">
                                 ...
                                 <div class="single-item p-single p-sm body-cn">
                                    <p>Creamos storyboards que mapean cada paso del usuario dentro del producto, asegurando una comprensión clave y efectiva del flujo
                              ...
                              <div class="service-f-single fade-top">
                                 ...
                                 <div class="single-item p-single p-sm body-cn">
                                    <p>Estructuramos tus ideas. Nuestros wireframes delinean la arquitectura básica de tu sitio o aplicación, estableciendo una fundación sólida
                                       sobre la cual construir experiencias detalladas.
                                    </p>
                                 </div>
                                 <button class="toggle-service-f"></button>
                              </div>
                              <div class="service-f-single fade-top">
                                 ...
                                 <div class="single-item p-single p-sm body-cn">
                                    <p>Damos vida a las ideas siendo nuestros prototipos funcionales e interactivos, permitiendo a los stakeholders obtener un sentido real del producto 
                                       final antes del desarrollo. 
                                    </p>
                                 </div>
                                 <button class="toggle-service-f"></button>
                              </div>
                              ...
                              <div class="row gaper align-items-center">
                                 <div class="col-12 col-lg-8">
                                    <div class="cta-two__content">
                                       ...
                                       <h5>
                                          <a href="mailto:info@foxstudio.com.ar">Contactanos</a>
                                       </h5>
                                    </div>
                                 </div>
                                 <div class="col-12 col-lg-4">
                                    <div class="text-start text-lg-end">
                                       <a href="https://calendly.com/foxstudioarg" class="btn btn--tertiary">
                                          AGENDÁ UNA REUNIÓN
